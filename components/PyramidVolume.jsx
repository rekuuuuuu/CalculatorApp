...
import { calculatePyramidVolume, resetPyramidVolume, dismissKeyboard, showAlertPopup } from "../components/Functions";

export const PyramidVolume = () => {
  ...
  const handlePress = () => {
    if ((area, height === "")) {
      ...
      const pyramidVolume = calculatePyramidVolume(area, height);
      setVolume(pyramidVolume);
      dismissKeyboard();
    }
  };
  ...
  return (
    <TouchableWithoutFeedback onPress={dismissKeyboard}>
      <View style={styles.body}>
        <Image source={require("../assets/角錐・円錐の体積公式.png")} style={styles.image} resizeMode="stretch" />
        <Text style={styles.title}>角錐・円錐の体積</Text>
        ...
        <TouchableOpacity style={styles.resetButton} onPress={() => resetPyramidVolume(setArea, setHeight, setVolume)}>
